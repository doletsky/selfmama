...
<?if($arParams["USE_CATEGORIES"]=="Y" && $ElementID):
	...
	<?endif?>
<?endif?>
<?$article_id = CStorage::getVar('article_id')?>
<?if (!empty($article_id)) {?>
<div class="comments-list">
    ...
    <?if (!empty($count)) {?>
        <div class="filter">
            ...
            <a href="/rss_articles.php" class="rss flr">Подписаться</a>
        </div>
    <?}?>
    <?
...
$APPLICATION->IncludeComponent("bitrix:news.list", "selfmama_articles_list_bottom",
    Array(
